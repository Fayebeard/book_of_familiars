This project is a mod for Minecraft. For specific versions, see the branches.
The mod adds a single item, the Familiar Book. This book allows players to store tamed creatures and release them anywhere in the world! It also includes a revive feature,
so you never have to worry about losing beloved tames when bringing them on adventures.
