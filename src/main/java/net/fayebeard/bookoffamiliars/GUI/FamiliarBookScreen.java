...
public class FamiliarBookScreen extends Screen {
    ...
    private void renderFamiliarNameAndType(GuiGraphicsExtractor guiGraphics, StoredFamiliar familiar) {
        ...
        guiGraphics.text(this.font, Component.literal(displayName),
